...
export default function VisitorFooter() {
  ...
  return (
    <footer className="relative bg-gray-900 text-gray-300 pt-24 pb-8">
      {/* Curved top section */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-white border-b border-[#188f8b] pb-2 inline-block">
              Our Services
            </h3>
            <ul className="space-y-3">
              {services.map((service) => (
                <li key={service.name}>
                  <Link 
                    href={service.path}
                    className="text-gray-400 hover:text-white hover:pl-2 transition-all duration-300 flex items-start"
                  >
                    <svg 
                      className="w-4 h-4 mt-1 mr-2 text-[#188f8b] flex-shrink-0" 
                      fill="none" 
                      stroke="currentColor" 
                      viewBox="0 0 24 24"
                    >
          ...
          <div className="space-y-4">
            ...
            <div className="mt-8">
              <h3 className="text-lg font-semibold text-white mb-4 border-b border-[#188f8b] pb-2 inline-block">
                Newsletter
              </h3>
              ...
              <form className="flex flex-col sm:flex-row gap-2">
                <input
                  ...
                  className="px-4 py-3 rounded-md bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-[#188f8b] w-full"
                  required
                />
                <button
                  type="submit"
                  className="bg-[#188f8b] hover:bg-[#147a76] text-white px-6 py-3 rounded-md transition-all duration-300 hover:shadow-lg hover:shadow-[#188f8b]/30 whitespace-nowrap"
                >
                  Subscribe
                </button>
              </form>
