...
export default function VisitorFooter() {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      url: "https://www.linkedin.com/company/seraxmi"
    },
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <a
                    href="tel:+91 73002 10822"
                    className="text-gray-400 hover:text-white hover:underline transition-colors duration-300"
                  >
                    Global Support: +91 73002 10822
                  </a>
                </motion.div>
              </div>
          ...
          {success && (
            <motion.div
              ...
              exit={{ opacity: 0, y: 50 }}
              className="fixed bottom-6 right-6 bg-green-600 text-white px-6 py-4 rounded-lg shadow-lg z-50"
            >
