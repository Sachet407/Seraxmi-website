  ...
  return (
    <div className="w-[90vw] md:w-[80vw] bg-gray-900 relative mx-auto rounded-3xl overflow-hidden">
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-8">
        {/* Header */}
        <div 
          className={`text-center mb-6 md:mb-8 lg:mb-12 transition-all duration-1200 ease-out ${
        ...
        {/* 3D Canvas */}
        <div 
          className={`relative w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] mb-3 lg:mb-12 transition-all duration-1200 ease-out ${
            isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}
