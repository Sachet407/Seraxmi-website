...
const WebDevelopmentPage = () => {
  const services = [
    ...
    },
    {
      ...
      icon: <Layout className="w-8 h-8 text-[#188f8b]" />,
  ...
  const processSteps = [
    {
      ...
      color: "from-[#188f8b] to-slate-700"
    },
    {
    ...
    },
    {
      ...
      color: "from-[#188f8b] to-emerald-700"
    }
  ];

  const stats = [
    { number: "500+", label: "Projects Delivered", icon: <Award className="w-6 h-6 text-[#188f8b]" /> },
    { number: "98%", label: "Client Satisfaction", icon: <Star className="w-6 h-6 text-[#188f8b]" /> },
    { number: "150+", label: "Happy Clients", icon: <Users className="w-6 h-6 text-[#188f8b]" /> },
    { number: "24/7", label: "Support Available", icon: <CheckCircle className="w-6 h-6 text-[#188f8b]" /> }
  ];

  return (
    <div className="relative overflow-hidden bg-white ">
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-gradient-to-br from-slate-50 via-[#188f8b]/10 to-slate-50">
        {/* Animated Background */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-[#188f8b]/10 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-[#188f8b]/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
          <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-gradient-to-r from-[#188f8b]/5 to-[#188f8b]/10 rounded-full blur-3xl animate-spin duration-[20s]"></div>
        </div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80  border border-[#188f8b]/30 rounded-full text-sm font-medium shadow-lg backdrop-blur-sm mb-6">
                <Zap className="w-4 h-4 animate-pulse text-[#188f8b] " />
                <span className="bg-gradient-to-r from-[#188f8b] to-slate-700  bg-clip-text text-transparent">
                  Premium Web Solutions
                </span>
              </div>
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight bg-gradient-to-r from-slate-900 to-slate-700   bg-clip-text text-transparent mb-6">
                Web Development
                <span className="block text-3xl sm:text-4xl md:text-5xl lg:text-6xl bg-gradient-to-r from-[#188f8b] to-slate-600 bg-clip-text text-transparent">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <button className="px-8 py-4 bg-gradient-to-r from-[#188f8b] to-[#136a67] text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 hover:brightness-110">
            ...
            <div className="relative">
              <div className="relative bg-gradient-to-br from-white to-slate-50  rounded-2xl shadow-2xl overflow-hidden border border-slate-200 ">
                <Image
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="flex items-center gap-3 bg-white/95 backdrop-blur-sm rounded-lg px-4 py-3 shadow-lg">
                    <div className="w-3 h-3 bg-[#188f8b] rounded-full animate-pulse"></div>
                    <span className="text-sm font-medium text-slate-700">Live Development in Progress</span>
                  </div>
                </div>
              </div>
              {/* Floating elements */}
              <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-[#188f8b]/80 to-slate-400/80 rounded-2xl rotate-12 opacity-60 animate-bounce"></div>
              <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-gradient-to-br from-[#188f8b]/80 to-[#136a67]/80 rounded-xl -rotate-12 opacity-60 animate-bounce delay-500"></div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center group">
                <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br from-[#188f8b]/10 to-slate-500/10 rounded-xl mb-3 group-hover:scale-110 transition-transform duration-300">
                  {stat.icon}
                </div>
      ...
      {/* Services Grid */}
      <section className="py-20 md:py-28 bg-gradient-to-br from-slate-50/50 to-[#188f8b]/5 ">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="group bg-white  rounded-2xl shadow-lg hover:shadow-2xl border border-slate-200  overflow-hidden transition-all duration-500 hover:-translate-y-2"
              >
                ...
                <div className="p-6">
                  ...
                  <ul className="space-y-2 mb-6">
                    {service.features.map((feature, i) => (
                      <li key={i} className="flex items-center">
                        <div className="w-5 h-5 bg-gradient-to-br from-[#188f8b] to-[#136a67] rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                  ...
                  <button className="inline-flex items-center text-[#188f8b] hover:text-[#136a67] font-medium group">
                    Learn more
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-br from-slate-700 via-[#188f8b] to-slate-800 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
              ...
              <span className="block bg-gradient-to-r from-white to-[#a3e0de] bg-clip-text text-transparent">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <button className="px-10 py-4 bg-white text-[#188f8b] font-semibold rounded-xl shadow-lg hover:bg-slate-50 hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center group">
